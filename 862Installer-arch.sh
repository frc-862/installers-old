...
if has pacman ; then
    printf "\033[32mpacman installation detected\nupgrading pacman...\n\033[39m"
    $rootstring pacman -Syu
else
    printf "\033[31mpacman not found\ntry checking that this is the right installer for your distro or verifying that pacman is installed and in your PATH\n\033[39m"
    exit
fi
